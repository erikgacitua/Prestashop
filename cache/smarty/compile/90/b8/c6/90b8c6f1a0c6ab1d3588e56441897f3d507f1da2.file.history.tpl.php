<?php /* Smarty version Smarty-3.1.19, created on 2017-08-30 19:00:21
         compiled from "/var/www/html/prestashop/themes/default-bootstrap/history.tpl" */ ?>
<?php /*%%SmartyHeaderCode:29099907559a70b45bd4394-59481740%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '29099907559a70b45bd4394-59481740',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59a70b45ea5768_30762343',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59a70b45ea5768_30762343')) {function content_59a70b45ea5768_30762343($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include '/var/www/html/prestashop/tools/smarty/plugins/modifier.regex_replace.php';
?>
...
<?php $_tmp25=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order-opc',true,null,"submitReorder&id_order=".$_tmp25), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php } else { ?>
								<a class="link-button" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['order']->value['id_order']);?>
<?php $_tmp26=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"submitReorder&id_order=".$_tmp26), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php }?>
